...
export const NIHSSInputSchema = z.object({
  ...
  visual: z.enum(['no_loss', 'partial_hemianopia', 'complete_hemianopia', 'bilateral_hemianopia']).describe('3. Visual Fields: no_loss (0pts) - no visual loss; partial_hemianopia (1pt) - partial hemianopia; complete_hemianopia (2pts) - complete hemianopia; bilateral_hemianopia (3pts) - bilateral hemianopia, blind including cortical blindness'),
...
export const SOFAInputSchema = z.object({
  ...
  vasopressors: z.enum(['none', 'dopamine_low', 'dopamine_medium_or_epi_norepi_low', 'dopamine_high_or_epi_norepi_high']).describe('Vasopressor use (doses in μg/kg/min): none (0pts) - no vasopressors; dopamine_low (2pts) - dopamine ≤5 or dobutamine any dose; dopamine_medium_or_epi_norepi_low (3pts) - dopamine >5-15, OR epinephrine ≤0.1, OR norepinephrine ≤0.1; dopamine_high_or_epi_norepi_high (4pts) - dopamine >15, OR epinephrine >0.1, OR norepinephrine >0.1'),
