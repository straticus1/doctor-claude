...
import {
  ...
  MELD_MIN_SCORE,
  MELD_MAX_SCORE,
  MELD_BILIRUBIN_COEFFICIENT,
  MELD_INR_COEFFICIENT,
  MELD_CREATININE_COEFFICIENT,
  MELD_CONSTANT,
} from '../constants.js';

export function calculateMELD(inputs: z.infer<typeof MELDInputSchema>): ScoreResult {
  ...
  const rawScore =
    MELD_BILIRUBIN_COEFFICIENT * Math.log(bilirubin) +
