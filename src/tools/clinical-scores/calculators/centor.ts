...
import {
  CENTOR_AGE_YOUNG_MIN,
  CENTOR_AGE_YOUNG_MAX,
  CENTOR_AGE_MIDDLE_MIN,
  CENTOR_AGE_MIDDLE_MAX,
  CENTOR_AGE_OLD_MIN,
} from '../constants.js';

export function calculateCentor(inputs: z.infer<typeof CentorInputSchema>): ScoreResult {
  let score = 0;
